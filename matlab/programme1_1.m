...
margesecurite = 1;
debut_preambleB = debut_preambleB -margesecurite;
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
Pd_est=sum(abs(Matsymb(:)).^2)/length(Matsymb(:));
A=sqrt(10/Pd_est);
Matsymb = A*Matsymb;
...
A = imread('image.jpg');
imshow(A),title(['image mystere du signal1.1.mat  marge de securite = ',num2str(margesecurite)]);
