...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Ajuster la pussance à -30dBm
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
p=-30 %puissance PFDM EN dBm
Ps=sum(abs(s2).^2)/length(s2)%calcul de puissance
fprintf('vérif : %1.2f\n',10*log10(Ps))
kdB= (p-30)-10*log10(Ps) %calcul le A pour une puissance de -10 dbm
A=10^(kdB/20)

r=A*s2;   % signal aprés l'application de A 
...
% Vérifier le signal
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
verif_lte_symbol(r.',1,conf_cp,4,-60)% la verification de notre signal si OK ou PAS
